...
public sealed partial class CargoPalletMenu : FancyWindow
{
    ...
    public void SetAppraisal(int amount, int tax, bool moneyMode, string taxName)
    {
    ...
    public void SetStation(string selectedName, int taxingStation, int selectedStation, Dictionary<int, string> stations, bool moneyMode)
    {
        
        if (!moneyMode && taxingStation == selectedStation)
        {
