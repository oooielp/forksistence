...
{
    public sealed class StationTaggerBoundUserInterface : BoundUserInterface
    {
        ...
        public StationTaggerBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        ...
        protected override void Open()
        {
            ...
            _window.PrivilegedIdButton.OnPressed += _ => SendMessage(new ItemSlotButtonPressedEvent(StationTaggerComponent.PrivilegedIdCardSlotId));
            _window.BUI = this;
        ...
        protected override void UpdateState(BoundUserInterfaceState state)
        {
            ...
            var castState = (StationTaggerBoundUserInterfaceState) state;
